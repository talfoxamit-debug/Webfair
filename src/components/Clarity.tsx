...
/**
 * Microsoft Clarity: free heatmaps and session recordings, loaded only when
 * NEXT_PUBLIC_CLARITY_ID is set. Shows exactly where visitors click, scroll,
 * and drop off, the qualitative "why" behind the funnel numbers. Free forever.
 */
