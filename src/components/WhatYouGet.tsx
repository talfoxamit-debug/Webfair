...
export default function WhatYouGet() {
  return (
    <section id="process" className="relative border-y border-white/[0.06] py-20 sm:py-28">
      <div className="pointer-events-none absolute inset-0 grid-backdrop opacity-20" />
      <div className="container-content relative grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <Reveal>
          ...
          {whatYouGet.items.map((item, i) => {
            ...
            return (
              <Reveal key={item.title} delay={i * 100} className="relative">
                <span className="flex h-12 w-12 items-center justify-center rounded-xl border border-lime/25 bg-lime/10 text-lime shadow-glow-lime">
