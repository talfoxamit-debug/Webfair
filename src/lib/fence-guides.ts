...
export const GUIDES: Guide[] = [
  {
    ...
    body: [
      ...
      { li: [
        "Chain-link: $15 to $26/ft, the budget option, great for pets and perimeters.",
        "Wood privacy (cedar/pine): $28 to $45/ft, warm, classic, needs sealing every few years.",
        "Vinyl: $32 to $55/ft, zero maintenance and storm-rated; the most popular privacy choice here.",
        "Aluminum / ornamental: $35 to $60/ft, rust-proof, pool-code friendly, upscale look.",
      ] },
      { h: "What actually changes your price" },
      { li: [
        "Height: an 8-ft fence runs ~25% more than a 6-ft; a 4-ft is ~15% less.",
        "Gates: a walk gate adds $350 to $700; an automatic driveway gate is a project of its own.",
        "Terrain & access: slopes, rock, tree roots and tight backyards add labor.",
        "Demolition: removing an old fence is usually $3 to $8/ft on top.",
        "Permits: most South-FL cities require one. Budget $50 to $300 (a good contractor pulls it for you).",
      ] },
  ...
  },
  {
    ...
    body: [
      ...
      { p: "Cedar and pine give you that timeless look and full privacy for the lowest privacy-fence price. The trade-off is upkeep: Florida sun and humidity mean you'll want to seal or stain it every 2 to 3 years, and it has the shortest lifespan of the three (10 to 15 years)." },
      { h: "Vinyl: set it and forget it" },
      { p: "Vinyl is the most popular privacy fence in South Florida for a reason: no painting, no rot, no rust, and modern panels are engineered to take hurricane-force wind loads. It costs more upfront than wood but nothing after that, and it lasts 25 to 30 years. If you want privacy and never want to think about it again, this is it." },
